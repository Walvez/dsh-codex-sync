  ...
  return h('div', {
    ...
    h('div', {
      ...
      h('div', { key: 'main', style: Object.assign({}, styles.dialogBody, { padding: '16px 18px', display: 'flex', flexDirection: 'column', gap: '16px' }) },
        ...
        // Section 2: Features (功能开关) — every row: title + plain description
        // + optional "open config" button + switch. Skills/MCP are managed in
        // their own second-level pages (buttons in the Actions grid).
        h('div', { style: styles.modalSection },
          ...
          h('div', { style: styles.settingsGroup },
            ...SETTING_KEYS.map((key, index) => {
              ...
              const descKey = {
                ...
                enableSkills: 'descSkills',
                mcpMirror: 'descMcpMirror',
              }[key]
              ...
              return h('div', { key },
                h('div', {
                  ...
                  h('div', { style: { minWidth: 0, flex: 1 } },
                    h('div', { style: styles.settingName }, t.settingNames[key]),
                    h('div', { style: styles.settingDesc }, t[descKey]),
                    SETTING_INFO[key]?.[lang] && tooltipId === key
                      ? h('div', { style: Object.assign({}, styles.modalTooltip, { position: 'static', marginTop: '4px' }) }, SETTING_INFO[key][lang])
                      : null
                  ),
                  h('span', { style: styles.spacer }),
                  configTarget ? h('button', {
