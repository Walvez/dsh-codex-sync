...
/**
 * Second-level management page (inside the settings dialog): an open-config
 * shortcut row, then a search box, then ItemSyncPanel. The feature master
 * switch lives OUTSIDE (on the manager button in the Actions grid).
 */
function ItemsManagerPage({ lang, kind, itemsData, itemsLoading, onToggleItem, onSetAll }) {
  ...
  if (itemsLoading && itemsData === null) {
    return h('div', { style: styles.subpageBody }, h('span', { style: styles.settingName }, t.loading))
  }
  return h('div', { style: styles.subpageBody },
    // Open-config shortcut row (no switch here — master switch is outside).
    h('div', { className: 'codex-sync-row', style: Object.assign({}, styles.settingRowFull, { padding: '10px 12px' }) },
      h('div', { style: { minWidth: 0 } },
        h('div', { style: styles.settingName }, kind === 'skill' ? t.settingNames.enableSkills : t.settingNames.mcpMirror),
        h('div', { style: styles.settingDesc }, kind === 'skill' ? t.descSkills : t.descMcpMirror)
      ),
      h('span', { style: styles.spacer }),
      configOpener(kind === 'skill' ? 'skills' : 'config', t)
    ),
    h('input', {
      type: 'search',
      ...
      style: Object.assign({}, styles.search, { marginBottom: '2px' }),
    }),
    h(ItemSyncPanel, {
      lang,
      kind,
      ...
      h('div', { key: 'main', style: Object.assign({}, styles.dialogBody, { padding: '16px 18px', display: 'flex', flexDirection: 'column', gap: '16px' }) },
        ...
        h('div', { style: styles.modalSection },
          ...
          h('div', { style: styles.actionGrid },
            ...
            ...[['skill', 'enableSkills', Icons.codex(16), t.skillsPageTitle],
                ['mcp', 'mcpMirror', Icons.status(), t.mcpsPageTitle]].map(([kindKey, masterKey, icon, title]) => {
              ...
              return h('div', { key: `mgr-${kindKey}`, style: { position: 'relative' } },
                h('button', {
                  ...
                  h('span', { style: styles.actionCardLabel }, title),
                  typeof count === 'number' && count > 0
                    ? h('span', { style: Object.assign({}, styles.itemBadge, { marginLeft: 'auto', marginRight: '8px' }) }, t.expandHint(count))
                    : h('span', { style: Object.assign({}, styles.spacer, { marginRight: '8px' }) }),
                  h('span', {
        ...
        // Section 2: Features (功能开关) — single-line rows like the Actions
        // cards: name + ⓘ hover tooltip + ↗ open-config + switch. Descriptions
        // live in the tooltip to keep the section compact.
        h('div', { style: styles.modalSection },
            ...
            ...SETTING_KEYS.map((key, index) => {
              ...
              return h('div', { key, style: { position: 'relative' } },
                h('div', {
                  ...
                  h('div', { style: Object.assign({}, styles.settingName, { flex: '1 1 auto', minWidth: 0 }) }, t.settingNames[key]),
                  h('span', {
                    style: styles.infoIconWrapper,
