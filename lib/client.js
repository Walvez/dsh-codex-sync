...
const styles = {
  ...
  button: {
    ...
    borderRadius: '6px',
    background: 'var(--dsw-surface-subtle, rgba(127,127,127,0.06))',
  ...
  menu: {
    ...
    minWidth: '260px',
    zIndex: 1000,
    border: '1px solid var(--dsw-border-subtle, rgba(127,127,127,0.22))',
    borderRadius: '10px',
    ...
    padding: '6px',
    fontSize: '12px',
    animation: 'dshSyncFadeIn 0.15s cubic-bezier(0.4, 0, 0.2, 1)',
  },
  menuDown: { top: 'calc(100% + 5px)' },
  menuUp: { bottom: 'calc(100% + 5px)' },
  sectionTitle: {
    padding: '6px 8px 3px',
    color: 'var(--dsw-text-tertiary, #8e8e93)',
    fontSize: '10px',
    fontWeight: '600',
  ...
  divider: {
    height: '1px',
    margin: '4px 6px',
    background: 'var(--dsw-border-subtle, rgba(127,127,127,0.14))',
  },
  rowWrap: {
    position: 'relative',
    width: '100%',
  ...
  item: {
    ...
    color: 'var(--dsw-text-primary, #1c1c1e)',
    fontSize: '12px',
    textAlign: 'left',
    cursor: 'pointer',
    whiteSpace: 'nowrap',
  ...
  itemHover: {
    background: 'var(--dsw-surface-hover, rgba(127,127,127,0.09))',
  },
  rowLabel: {
    color: 'var(--dsw-text-primary, #1c1c1e)',
    fontWeight: '400',
  ...
  tagPill: {
    ...
    padding: '2px 7px',
    borderRadius: '6px',
    background: 'var(--dsw-surface-subtle, rgba(127,127,127,0.1))',
  ...
  tooltip: {
    ...
    padding: '7px 10px',
    borderRadius: '8px',
    background: 'var(--dsw-surface, #1e1e24)',
    border: '1px solid var(--dsw-border-subtle, rgba(127,127,127,0.25))',
    boxShadow: '0 8px 24px rgba(0,0,0,0.22)',
    color: 'var(--dsw-text-primary, #f5f5f7)',
    fontSize: '11px',
    lineHeight: '1.45',
    whiteSpace: 'normal',
...
function SyncMenu({ runCommand }) {
  ...
  /** Render iOS-style switch slider */
  const renderSwitch = (isOn) => {
    const bg = isOn === true
      ? 'var(--dsw-accent, #10b981)'
      : isOn === false
        ? 'var(--dsw-surface-subtle, rgba(127,127,127,0.22))'
        : 'var(--dsw-surface-subtle, rgba(127,127,127,0.12))'
    return h('span', {
