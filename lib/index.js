 ...
 *   4. Optional MCP servers mounted through @deepseek-ai/dsh-mcp-client,
...
export function apply(ctx, config = {}) {
  ...
  if (config.mcpMirror !== false) {
    ctx.effect(() => startMcpMirror(ctx, codexHome, config), 'codex-sync.mcp-mirror()')
  }
}
